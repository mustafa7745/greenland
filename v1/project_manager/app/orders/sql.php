...
class OrdersSql extends \OrdersAttribute
{
    ...
    function addSql($userId): string
    {
        ...
        $values = "(NULL,$userId,0,'$date','$date')";
        /////
    ...
    protected function updatePaidSql($id, $newValue): string
    {
        $date = getCurruntDate();
        $table_name = $this->table_name;
        $set_query = "SET $this->paid = $newValue, $this->updatedAt = '$date'";
        $condition = "$this->id = $id";
        /////
        return shared_update_sql($table_name, $set_query, $condition);
    }
...
{
    function addSql($orderId, $price, $actualPrice, $userLocationId, $deliveryManId): string
    {
        $date = getCurruntDate();
        $table_name = $this->table_name;
        ...
        $values = "(NULL,$price,$actualPrice,$userLocationId,$deliveryManId, $orderId,'$date','$date')";
        /////
        return shared_insert_sql($table_name, $columns, $values);
    }
    function readByIdSql($id): string
    ...
    protected function updateBothPriceSql($id, $newValue): string
    {
        $date = getCurruntDate();
        $table_name = $this->table_name;
        $set_query = "SET $this->price = $newValue, $this->actualPrice = $newValue, $this->updatedAt = '$date'";
        $condition = "$this->id = $id";
        /////
        return shared_update_sql($table_name, $set_query, $condition);
    }
