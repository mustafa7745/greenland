...
$ids_controller1_helper = null;
function getIdsControllerHelper()
{
  global $ids_controller1_helper;
  if ($ids_controller1_helper == null) {
    $ids_controller1_helper = new IdsControllerHelper();
  }
  return $ids_controller1_helper;
}