...
// 
class ManagersHelper extends ManagersSql
{
  // public $name = "APP";
...
$managers_helper = null;
function getManagersHelper()
{
  global $managers_helper;
  if ($managers_helper == null) {
    $managers_helper = new ManagersHelper();
  }
  return $managers_helper;
}